...
- **ID de acceso:** NC_000866.4
- **Tipo de genoma:** dsDNA
- **Tamaño:** ~169 kpb
- **Enlace directo:** [https://www.ncbi.nlm.nih.gov/nuccore/NC_000866.4](https://www.ncbi.nlm.nih.gov/nuccore/NC_000866.4)
- **Archivo descargado:** `T4_genoma_completo.fasta` (ubicado en `DATA/raw/`)
## FLUJO DE TRABAJO:  
## RESULTADOS:  
